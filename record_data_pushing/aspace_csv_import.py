...
ASPACE_URL = "https://archivesspace-staff.lib.uchicago.edu"  # No /api
...
class ArchivesSpaceClient:
    ...
    def __init__(self, username: str = None, password: str = None):
        self.base_url = f"{ASPACE_URL}/api"
    ...
    def check_component_unique_id(self, component_id: str) -> Tuple[bool, Optional[str]]:
        ...
        search_params = {
            "q": f'component_unique_identifier:"{component_id}"',
    ...
    def create_top_container(self, indicator: str, barcode: str) -> Optional[str]:
...
def create_instances(row: Dict, client: ArchivesSpaceClient) -> List[Dict]:
    ...
    # Create top container using catalog number as both indicator and barcode
    container_uri = client.create_top_container(catalog_number, catalog_number)
